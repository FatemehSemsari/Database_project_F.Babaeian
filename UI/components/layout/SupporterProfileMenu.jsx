...
export default function SupporterProfileMenu(){
  ...
  updated_at: "2026-08-14T16:45:00Z",
    ...
    return(
        <div className=" mt-25 rounded-xl text-white w-2/12 h-auto p-5 bg-[#10243D]">
            <div className=" flex flex-col gap-3 items-center">
                ...
                <h1>{mockUser.first_name} {mockUser.last_name}</h1>
                <h3 className=" text-sm">{mockUser.email}</h3>
                <h3 className=" text-sm">{mockUser.phone}</h3>
            </div>
