export default function ReserveCardPaied({seats, away_team_name, home_team_name,venue_name, city_name, total_amount, event_datetime, paid_at, reservation_id}){
    ...
    return(
        <div className=" bg-white rounded-lg w-full p-3 flex flex-col  gap-2">
            ...
            <div className="flex gap-2 items-start">
                <button className=" text-[#52D15C] border-[#52D15C] p-3 rounded-lg" onClick={refundHandler}>درخواست استرداد وجه</button>
                <button className=" p-3 rounded-lg" onClick={showHandler}>مشاهده بلیط</button>
            </div>
        </div>
    )
}