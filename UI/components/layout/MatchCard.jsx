...
export default function MatchCard({sport_name, eventTicket, clickHandler, venue_name, home_team_logo, home_team_name, away_team_name,away_team_logo, date, time, price}){
    return(
        <div className=" shadow-2xl bg-white w-3/12 rounded-xl h-auto p-5 m-5">
            ...
            <div className="">
                <div className=" m-2 flex font-bold justify-around items-center ">
                    <div>
                    <Image src={away_team_logo}></Image>
                    <h2>{away_team_name}</h2>
                    </div>
                    <div>
                    <Image src={home_team_logo}></Image>
                ...
                <h2 className=" text-center m-3">از { price } تومان</h2>
                <button onClick={()=>clickHandler(eventTicket)}  className=" text-black  font-bold flex w-11/12 m-auto items-center justify-center bg-[#52D15C] p-3 rounded-lg">
