...
from apps.tickets.views import search_tickets, ticket_details, my_bookings, cancellation_info, cancel_ticket, advanced_search_tickets
...
urlpatterns = [
    ...
    path("advanced-search/", advanced_search_tickets, name="advanced-search"),
]