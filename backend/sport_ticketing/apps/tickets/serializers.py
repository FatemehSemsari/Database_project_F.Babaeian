...
class UserBookingSerializer(serializers.Serializer):
    ...
    booking_state = serializers.CharField()
    issue_date = serializers.DateTimeField(allow_null=True)
    reservation_id = serializers.IntegerField()
    reservation_status = serializers.CharField(allow_null=True, allow_blank=True)
    ...
    ticket_category_id = serializers.IntegerField()
    ticket_category_name = serializers.CharField(allow_null=True, allow_blank=True)
    purchase_price = serializers.IntegerField(allow_null=True)
    section_id = serializers.IntegerField()
    section_name = serializers.CharField()
    ...
    gate = serializers.CharField(allow_null=True, allow_blank=True)


class CancellationInfoSerializer(
    ...
    min_hours_before_event = serializers.FloatField(allow_null=True)
    max_hours_before_event = serializers.FloatField(allow_null=True)
    refund_percent = serializers.IntegerField(allow_null=True)
    penalty_percent = serializers.IntegerField(allow_null=True)
    refund_amount = serializers.IntegerField(allow_null=True)
    penalty_amount = serializers.IntegerField(allow_null=True)
    policy_notes = serializers.CharField(allow_null=True, allow_blank=True)
    reason = serializers.CharField(allow_null=True, allow_blank=True)



class CancelTicketResponseSerializer(serializers.Serializer):
    ticket_id = serializers.IntegerField()
    ticket_status = serializers.CharField()
    reservation_id = serializers.IntegerField()
    reservation_status = serializers.CharField()
